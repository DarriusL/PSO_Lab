%configuration file（BasePSO, primary，unimodal test function 7, search）
function stc = basepso_primary_unimodal_7_soclLrnFactor_benchmark_config
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.unimodal().fun7.function;
