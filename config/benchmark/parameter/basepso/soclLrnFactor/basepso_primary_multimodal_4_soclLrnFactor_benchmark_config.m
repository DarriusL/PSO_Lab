%configuration file（BasePSO, primary，Multimodal test function 4, search）
function stc = basepso_primary_multimodal_4_soclLrnFactor_benchmark_config
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.multimodal().fun4.function;
