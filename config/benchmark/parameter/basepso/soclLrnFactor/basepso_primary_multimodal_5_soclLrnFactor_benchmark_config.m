%configuration file（BasePSO, primary，Multimodal test function 5, search）
function stc = basepso_primary_multimodal_5_soclLrnFactor_benchmark_config
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.multimodal().fun5.function;
