%configuration file（BasePSO, primary，Multimodal test function 6, search）
function stc = basepso_primary_multimodal_6_soclLrnFactor_benchmark_config
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.multimodal().fun6.function;
