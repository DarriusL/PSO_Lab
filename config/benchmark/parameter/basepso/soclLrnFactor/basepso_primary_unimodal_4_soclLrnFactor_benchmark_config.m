%configuration file（BasePSO, primary，unimodal test function 4, search）
function stc = basepso_primary_unimodal_4_soclLrnFactor_benchmark_config
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.unimodal().fun4.function;
