%configuration file（BasePSO, primary，unimodal test function 2, search）
function stc = basepso_primary_unimodal_2_soclLrnFactor_benchmark_config
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.unimodal().fun2.function;
