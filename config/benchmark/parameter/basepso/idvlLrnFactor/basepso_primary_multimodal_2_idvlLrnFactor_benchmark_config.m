%configuration file（BasePSO, primary，Multimodal test function 2, search）
function stc = basepso_primary_multimodal_2_idvlLrnFactor_benchmark_config
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.multimodal().fun2.function;
