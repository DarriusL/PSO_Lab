%Joint simulation, all algorithms, precision
function stc = joint_all_precision_benchmark_config
...
%% Basic configuration
    ...
    %Fitness function
    stc.fit_fun = testfun_stc.precision.function;
